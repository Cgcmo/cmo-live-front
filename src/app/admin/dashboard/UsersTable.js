...
export default function UsersTable({fetchAllStats}) {
  ...
  const toggleStatus = async (id, currentStatus) => {
    try {
      const response = await fetch(`https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/update-user/${id}`, {
        method: "PUT",
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/users");
  ...
  if (password && password.length > 0) {
    ...
    try {
      const response = await fetch(`https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/update-user/${editedUser._id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/add-staff", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
