...
export default function DepartmentsTab() {
  ...
  const handleSaveEdit = (index) => {
    if (editedName.trim() !== "") {
      fetch(`https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/departments/${departments[index].name}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDelete = (name) => {
    fetch(`https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/departments/${name}`, { method: "DELETE" })
