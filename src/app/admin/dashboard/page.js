...
function App() {
  ...
  const fetchAllStats = async () => {
    try {
      const [userRes, albumRes, photoRes, downloadRes] = await Promise.all([
        axios.get("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/count-users"),
        axios.get("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/count-albums"),
        axios.get("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/count-photos"),
        axios.get("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/get-download-count"),
      ]);
  ...
  useEffect(() => {
    const fetchDownloadCount = async () => {
      try {
        const res = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/get-download-count");
