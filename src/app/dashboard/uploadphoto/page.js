  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      if (eventSelect && eventSelect !== "Select Event") {
        const eventResponse = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/fetch-album-photos", {
          method: "POST",
      ...
      if (selectedDate) {
        const dateResponse = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/fetch-photos-by-date", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          mode: "cors",
      ...
      if (file) {
        ...
        reader.onloadend = async () => {
          ...
          const uploadResponse = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/search-by-upload", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
setCurrentPage(1);
  ...
  const handleDownloadC = async () => {
    try {
      await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/increment-download-count", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      });
  ...
  const fetchEvents = async () => {
    try {
      const response = await fetch("https://0258-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/get-events");
