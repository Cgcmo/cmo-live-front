...
const Profile = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (storedUser) {
          ...
          const res = await fetch(`https://5f64-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/get-user-by-email/${session.user.email}`);
        ...
        const districtRes = await fetch("https://5f64-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/districts");
  ...
  const handleUpdate = async () => {
    ...
    if (session?.user?.email) {
      ...
      try {
        const res = await fetch("https://5f64-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/save-google-user", {
          method: "POST",
      ...
      try {
        const res = await fetch(`https://5f64-2409-4043-400-c70d-f18c-bef4-7b7d-6e83.ngrok-free.app/update-client/${user.userId}`, {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
